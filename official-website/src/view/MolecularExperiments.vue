<template>
    <div id="Service">
        <div class="banner container-fuild text-center">分子实验</div>
        <div class="container text-center">
            <h3>分子实验</h3>
            <p style="color:#b2b2b2">Molecular Experiments</p>
        </div>
        <div class="container">
            <div class="Service-container row clearfix">
                <div class="Service-item col-xs-12 col-sm-6 col-md-3 wow " v-for="(item, index) in MolecularExperimentsList"
                    :key="index">
